...
# create class for handeling exceptions
...
if __name__ == "__main__":
	...
	outputStock_file = "output_stock_GOOG.csv"
	outputTwitter_file = "output_sentiment_5min_GOOG.csv"
	...
	# 				print 'Its value:\n', e.line
	# 			else:
	# 				# state output of array below!!!!close_time","TICKER","OPEN","HIGH","LOW","CLOSE","VOL"
	# 				writer.writerow([line[0], line[1], line[5], line[6], line[7], line[8], line[9]])

	# # load twitter data for each set of the selected amount of twitterfiles run the full process
	...
	result = dfile.to_csv('output_GOOG_5min.csv',index=False)
